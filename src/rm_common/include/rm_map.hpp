...
#ifndef RM_COMMON_MAP_HPP
#define RM_COMMON_MAP_HPP
...
double GetMapPointOccupancy(const nav_msgs::msg::OccupancyGrid *map, double x, double y, double threshold = 0.9)
{
...
double LineSegmentIsIntersectMapObstacle(const nav_msgs::msg::OccupancyGrid *map,double x1, double y1, double x2, double y2, int divider = 20, double threshold = 0.9)
{
    int i = 0;
    if(divider < 0)
        divider = 10;
