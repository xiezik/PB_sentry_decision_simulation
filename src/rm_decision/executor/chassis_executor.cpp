...
{
  // ros::NodeHandle nh;
  cmd_vel_acc_pub_ = nh.advertise<rm_decision_interfaces::msg::TwistAccel>("cmd_vel_acc", 100);
  cmd_vel_pub_     = nh.advertise<geometry_msgs::msg::Twist>("cmd_vel", 1);
...
void ChassisExecutor::GlobalPlannerFeedbackCallback(const rm_decision_interfaces::action::GlobalPlanner::Feedback::ConstSharedPtr& global_planner_feedback){
